# Generated by Django 4.2.7 on 2025-04-28 13:32
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('artiste', 'Artiste'), ('proprietaire', 'Propriétaire')], max_length=20)),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.group', verbose_name='groups')),
                ('user_permissions', models.ManyToManyField(blank=True, help_text='Specific permissions for this user.', related_name='user_set', related_query_name='user', to='auth.permission', verbose_name='user permissions')),
            ],
            options={
                'permissions': [('edit_user', 'Can edit user'), ('get_user', 'Can get user')],
            },
            managers=[
        ...
        migrations.CreateModel(
            ...
            options={
                'permissions': [('get_artists', 'Can get artists')],
            },
        ),
        migrations.CreateModel(
            name='Artist',
            ...
            options={
                'permissions': [('get_countries', 'Can get countries')],
            },
        ),
        migrations.CreateModel(
            name='Admin',
            ...
            options={
                'permissions': [('get_countries', 'Can get countries'), ('get_artists', 'Can get artists'), ('add_user', 'Can add user'), ('delete_user', 'Can delete user'), ('edit_other', 'Can edit other users'), ('add_country', 'Can add country'), ('edit_country', 'Can edit country'), ('delete_country', 'Can delete country')],
            },
        ),
    ]
